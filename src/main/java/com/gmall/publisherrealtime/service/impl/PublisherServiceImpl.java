package com.gmall.publisherrealtime.service.impl;
...
public class PublisherServiceImpl implements PublisherService {
    ...
    public List<NameValue> doStatsByItem(String itemName, String date, String t) {
        //业务处理
        List<NameValue> searcherResults = publisherMapper.searchStatsByItem(itemName, date, typeToField(t));
        return transformResults(searcherResults, t);
    }
    ...
    public List<NameValue> transformResults(List<NameValue> searchResults, String t) {
        if ("gender".equals(t)) {
            ...
            if (searchResults.size() > 0) {
                ...
                searchResults.add(new NameValue("20岁到29岁", totalAmount20to29));
